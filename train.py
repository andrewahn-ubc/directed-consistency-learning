...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Which base LLM + hinge guard pairing to train (see model_profiles.py).",
    )
    parser.add_argument(
        "--base-llm",
        default="",
    ...
    parser.add_argument(
        ...
        help="Path prefix for saved LoRA adapters (writes <prefix>_epoch<N>/).",
    )
    parser.add_argument(
        "--training-data",
        default="data/train/train_plus_validation.csv",
        help="CSV with anchor prompts, refusals, and GCG/AutoDAN/PAIR variants (~3k rows).",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "'default' uses the profile's default_system_prompt."
        ),
    )
    parser.add_argument(
        "--lm-loss-input",
